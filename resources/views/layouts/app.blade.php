...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <title>{{ __('Temp EN') }}</title>
    <link rel="apple-touch-icon" sizes="76x76" href="{{ asset('material') }}/img/iconSyshika.png">
    <!-- <link rel="icon" type="image/png" href="{{ asset('material') }}/img/iconSyshika.png"> -->
    <meta content='width=device-width, initial-scale=1.0, maximum-scale=1.0, user-scalable=0, shrink-to-fit=no' name='viewport' />
    <!--     Fonts and icons     -->
    <!-- ACA VAN LOS LINKS DE LOS CSS + JAVASCRPIT + EL FORM DEL LOGOUT -->
    <link rel="stylesheet" type="text/css" href="https://fonts.googleapis.com/css?family=Roboto:300,400,500,700|Roboto+Slab:400,700|Material+Icons" />
    <link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/font-awesome/latest/css/font-awesome.min.css">
    <!-- CSS Files -->
    <link href="{{ asset('material') }}/css/material-dashboard.css?v=2.1.1" rel="stylesheet" />
    <link href="{{ asset('material') }}/css/csspropio.css" rel="stylesheet" />
    ...
    <body class="{{ $class ?? '' }}">
        ...
        <script src="{{ asset('material') }}/js/efectospropios.js"></script>
        @stack('js')
    </body>
</html>